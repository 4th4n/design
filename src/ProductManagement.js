  ...
  return (
    <div className="row">
      <div className="col-lg-4">
        ...
        <Form.Control type="product" id="prodName" value={prodName}placeholder='product'
              onChange={(e) => setProdName(e.target.value)} required style={styles.inputStyles}  />
        </FloatingLabel>
          
          <FloatingLabel >Price </FloatingLabel>
          <FormControl type="number" id="Price" name="Price" value={price}
              onChange={(e) => setPrice(e.target.value)} required style={styles.inputStyles}/>
      
       <FloatingLabel >Stock </FloatingLabel>
          <FormControl type="number" id="stock" name="stock" value={stock}
